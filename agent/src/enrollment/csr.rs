...
pub fn build_csr(cfg: &Config, identity: &Identity) -> Result<String> {
    ...
    let mut params =
        CertificateParams::new(vec![format!("{}.{}", identity.device_id, cfg.workspace_id)])?;
...
mod tests {
    ...
    fn csr_contains_workspace_and_device_claims() {
        ...
        let cfg = Config {
            ...
            connector_addr: String::new(),
            connector_server_name: String::new(),
            dataplane_ping_interval_secs: 15,
        };
